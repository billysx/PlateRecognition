...
def detect_resnet18(pretrained=False, **kwargs):
...
def detect_resnet34(pretrained=False, **kwargs):
...
def detect_resnet50(pretrained=False, **kwargs):
...
def detect_resnet101(pretrained=False, **kwargs):
...
def detect_resnet152(pretrained=False, **kwargs):
